...
class Securitytaken_model extends My_Model {
	protected $_table = 'security_taken';
	...
	/**
	 * Get total amount taken as securty 
	 * @access public
	 * @return array
	 */
   ...
   public function update_adjust_amount($id, $amount_to_add){
	...
	public function delete_payment($id){
  		...
  		if($this->db->affected_rows() > 0){
	  		$this->db->where('income_type', 'security');
