	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Customer List</h6>
				</header>
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#customer/save">Add New Customer</a>                            
	                </div>
	                <br>
					<div class="span12 center">
							...
							<div class="table-responsive">
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										...
										<tr id="row-customers-<?php echo $customer->customer_id;?>">
											<td><?php echo $c; ?></td>
											...
											<td>
												...
												<a class="btn btn-edit" href="#customer/save/<?php echo $customer->customer_id;?>"><i class="fa fa-lg fa-fw fa-edit"></i> Edit</a>
												<!-- <a class="btn btn-info" data-toggle="modal" data-target="#remoteModal" href="account/depositor_ledger/<?php echo $customer->customer_id;?>" id="ledger_customer" ><i class="icon-trash icon-white"></i> Ledger</a> -->
												&nbsp;&nbsp;&nbsp;
												<button class="btn btn-danger del" onclick="deleteCustomer(<?php echo $customer->customer_id;?>)" id="delete_customer" ><i class="fa fa-lg fa-fw fa-trash"></i></button>
											</td>
										</tr>
										<?php 
											$c++;
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data.success == 'true') {
						$('#row-customers-'+id).fadeOut().remove();
						$.bigBox({
							title : "Success",
