<?php
	$null_var1 = null;
	$null_var2 = null;
	$bill = sale_bill_cal_info($bill, $null_var1, $null_var2);
?>
<div class="row">
							...
							<fieldset>
								...
								<div class="row">
									<section class="col col-2 has-warning">
	                                    <label class="control-label" for="receivable_due_amt"><strong>PAYMENT DUE</strong> <small><small><small></small></small></small></label>
	                                </section>
	                                <section class="col col-3 has-warning">
	                                    <label class="input"> 
	                                    	<input type="text" name="receivable_due_amt" value="<?php echo $bill->receivable_due_amt?>" id="receivable_due_amt" class="span5" placeholder="Will generate automatically" readonly="readonly">
	                                    </label>
	                                </section>
	                                <section class="col col-1">
	                                	Tk
...
<script type="text/javascript">
	...
	$('#amount').change(function(){
		...
		var bill_due_amt = parseFloat($('#bill_due_amt').val());
		...
		new_bill_due_amt = (bill_due_amt - paid).toFixed(2);
		$('#new_due').val(new_bill_due_amt);
	});
