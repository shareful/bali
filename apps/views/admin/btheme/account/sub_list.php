...
<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-bank"></i> <a href="#account">Account</a>: <?php echo $account->name ?> <span>> Sub Accounts</span></h1>
	</div>
	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Sub Accounts List</h6>
				</header>
				<div class="form-actions">
					<?php
					if (isset($account->acc_id)) {?>
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#account/sub_save/<?php echo $account->acc_id ?>">Add New Sub Account</a>                            
	                </div>
	                <br>
	                <?php 
	            	}
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th data-class="expand">Acc Number/Code</th>
											<th data-class="expand">Sub Account Name</th>
									...
									<tbody>
										...
										<tr id="row-accounts-<?php echo $sub->sub_acc_id;?>">
											<td><?php echo $c; ?></td>
											<td>
												<?php
													echo $sub->code;
											...
											<td>
												<a class="btn btn-edit" href="#account/sub_save/<?php echo $account->acc_id ?>/<?php echo $sub->sub_acc_id;?>"><i class="fa fa-lg fa-fw fa-edit"></i> Edit</a>
											</td>
										</tr>
										<?php 
											$c++;
