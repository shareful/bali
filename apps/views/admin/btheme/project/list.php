	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Project List</h6>
				</header>
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#project/save">Add New Project</a>                            
	                </div>
	                <br>
					<div class="span12 center">
							...
							<div class="table-responsive">
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										...
										<tr id="row-projects-<?php echo $project->project_id;?>">
											<td><?php echo $c; ?></td>
...
<script type="text/javascript">
	var deleteProject=function(id){
		if (confirm('Are you sure want to delete the Project?')) {			
			var $btn = $(this);
			$btn.val('loading');
			$btn.attr({disabled: true});

			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>project/delete",
				type : "post",
				dataType : "json",
				data : 'id='+id,
				success : function(data) {
					...
					if (data.success == 'true') {
						$('#row-projects-'+id).fadeOut().remove();
						$.bigBox({
							title : "Success",
