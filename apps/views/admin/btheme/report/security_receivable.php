...
<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-file-excel-o"></i> Report <span>> Security Receivable</span></h1>
	</div>
	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Security Receivable Report</h6>
				</header>
				<div class="form-actions">
						...
						<div class="widget-body no-padding">
							<div class="table-responsive" >
								<table class="table table-striped table-bordered table-hover display compact" cellspacing="0"  width="100%" id="report_table">
									...
									<?php $this->load->view($admin_theme.'/report/security_receivable_data', array('bills' => $bills, 'total_amount'=>$total_amount )); ?>
								</table>
							</div>
						</div>						
					</div>
...
<script type="text/javascript">
    ...
    $("#filter_report").click(function(){
		...
		$.ajax({
			url : "<?php echo $this->config->item('base_url') ?>report/security_receivable",
			type : "post",
			dataType : "json",
