	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Advance Received List</h6>
				</header>
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#advancereceived/save">Receive New Advance</a>                            
	                </div>
	                <br>
					<div class="span12 center">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										...
										<tr id="row-records-<?php echo $record->id;?>">
											...
											<td><?php echo $record->customer->code.' - '.$record->customer->name; ?></td>
											...
											<td>
												...
												<a class="btn btn-edit" href="#advancereceived/adjust/<?php echo $record->id;?>"><i class="fa fa-lg fa-fw fa-edit"></i> Adjust</a>
												<a class="btn btn-edit" data-toggle="modal" data-target="#remoteModal" href="advancereceived/ledger/<?php echo $record->id;?>"><i class="fa fa-lg fa-fw fa-list"></i> Adjustments </a>
												&nbsp;&nbsp;&nbsp;
												<button class="btn btn-danger del" onclick="deleteAdvance(<?php echo $record->id;?>, this)" ><i class="fa fa-lg fa-fw fa-trash"></i></button>
											</td>
										</tr>
										<?php 
											$c++;
...
<script type="text/javascript">
	var deleteAdvance=function(id, btn){
		if (confirm('Are you sure want to delete the Advance Received Payment?')) {			
			var $btn = $(btn);
			// $btn.val('loading');
			$btn.attr({disabled: true});

			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>advancereceived/delete",
				type : "post",
				dataType : "json",
				data : 'id='+id,
				success : function(data) {
					...
					if (data.success == 'true') {
						...
						$.bigBox({
							title : "Success",
							content : "Advance Received Payment deleted.",
							color : "#739E73",
							timeout: 8000,
							icon : "fa fa-check",
							number : ""
