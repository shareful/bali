<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel"><i class="fa fa-lg fa-fw fa-list"></i> <strong>Adjustments History of Security Received # <?php echo $security->code ?> </strong></h4>
</div>
			...
			<div class="widget-body">
				<table class="table table-striped table-bordered" id="smith_table">
					...
					<tbody>
						...
						$total_due = ($security->amount - $total_adjusted);
						?>
					</tbody>
					<tfoot>
						<tr>
