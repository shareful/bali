		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
				<header>
					...
					<h2>Receive Security Payment Form</h2>				
				</header>
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="securityreceived/save" method="post" class="smart-form" id="fromsecurityreceived">
							<fieldset>
								<legend>Info</legend>
								<div class="row">
                            ...
                            <div class="form-actions">	          
	                            ...
	                            <input type="button" name="submit" class="btn-lg btn-success" id="make_payment" value="Receive Security Payment Now" />
	                        </div>
						</form>
...
<script type="text/javascript">
    ...
    $("#make_payment").click(function(){
		// if (confirm('Are you sure want to process This Payment?')) {			
			...
			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>securityreceived/save/",
				type : "post",
				dataType : "json",
				data : $("#fromsecurityreceived").serialize(),
				success : function(data) {
					$btn.attr({disabled: false});
					$btn.val('Receive Security Payment Now');
					if (data.success == 'true') {
						...
						$("form#fromsecurityreceived").trigger("reset");
