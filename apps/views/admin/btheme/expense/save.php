			...
			<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="expense/save" method="post" class="smart-form" id="fromexpense">
							<fieldset>
								<legend>Info</legend>
								<div class="row">
								...
								<div class="row">
									...
									<section class="col col-2">
										<label for="supplier_id" class="control-label">Expense Type</label>
									</section>
									<section class="col col-4">	
										<label class="input">
											<input type="text"  value="Other" class="span5" readonly>
											<input type="hidden" name="exp_type" value="other" id="exp_type">
										</label>
									</section>
								</div>
...
<script type="text/javascript">
    ...
    $("#make_payment").click(function(){
		// if (confirm('Are you sure want to process This Payment?')) {			
			...
			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>expense/save/",
				type : "post",
				dataType : "json",
				data : $("#fromexpense").serialize(),
				success : function(data) {
					...
					if (data.success == 'true') {
						...
						$("form#fromexpense").trigger("reset");
						// window.open('expense/receipt/'+data.id, '_blank', 'toolbar=no,scrollbars=yes,resizable=yes,width=1020,height=780');
						location.hash = 'expense/index';
					} else if(data.error != ""){
						$.bigBox({
							title : "Error!",
							content : data.error,
