...
<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<i class="fa-fw fa fa-file-text"></i> <a href="#purchase/index/<?php echo $project->project_id ?>/<?php echo $item->item_id ?>">Go to Purchase Bills</a>
	</div>
</div>
	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Sales Bills</h6>
				</header>
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#sale/new_bill/<?php echo $project_id ;?>/<?php echo $item_id ;?>">New Bill</a>                            
	                </div>
	                <br>
					<div class="span12 center">
...
<script type="text/javascript">
	var deleteBill=function(id, btn){
		if (confirm('Are you sure want to delete the Bill?')) {			
			...
			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>sale/delete",
				type : "post",
				dataType : "json",
				data : 'id='+id,
