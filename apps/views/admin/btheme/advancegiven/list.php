	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				<header> 
					<span class="widget-icon"> <i class="fa fa-table"></i> </span><h6 style="float: left; margin: 0px; padding: 5px;"> Advance Given List</h6>
				</header>
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#advancegiven/save">Make a New Advance</a>                            
	                </div>
	                <br>
					<div class="span12 center">
									...
									<tbody>
										...
										<tr id="row-records-<?php echo $record->id;?>">
											...
											<td>
												...
												<a class="btn btn-edit" href="#advancegiven/adjust/<?php echo $record->id;?>"><i class="fa fa-lg fa-fw fa-edit"></i> Adjust</a>
												<a class="btn btn-edit" data-toggle="modal" data-target="#remoteModal" href="advancegiven/ledger/<?php echo $record->id;?>"><i class="fa fa-lg fa-fw fa-list"></i> Adjustments </a>
												&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	var deleteAdvance=function(id, btn){
		if (confirm('Are you sure want to delete the Advance Given Payment?')) {			
			var $btn = $(btn);
			// $btn.val('loading');
			$btn.attr({disabled: true});

			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>advancegiven/delete",
				type : "post",
				dataType : "json",
				data : 'id='+id,
				success : function(data) {
					...
					if (data.success == 'true') {
						...
						$.bigBox({
							title : "Success",
							content : "Advance Given Payment deleted.",
							color : "#739E73",
							timeout: 8000,
							icon : "fa fa-check",
							number : ""
