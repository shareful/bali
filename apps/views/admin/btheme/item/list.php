			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				...
				<div class="form-actions">
	                <div class="span12 center">
	                	<a class="btn btn-success withpadding" href="#item/save">Add New Item</a>                            
	                </div>
	                <br>
					<div class="span12 center">
									...
									<tbody>
										...
										<tr id="row-items-<?php echo $item->item_id;?>">
											...
											<td>
												...
												<a class="btn btn-edit" href="#item/save/<?php echo $item->item_id;?>"><i class="fa fa-lg fa-fw fa-edit"></i> Edit</a>
												<!-- <a class="btn btn-info" data-toggle="modal" data-target="#remoteModal" href="account/depositor_ledger/<?php echo $item->item_id;?>" id="ledger_item" ><i class="icon-trash icon-white"></i> Ledger</a> -->
												&nbsp;&nbsp;&nbsp;
												<button class="btn btn-danger del" onclick="deleteItem(<?php echo $item->item_id;?>)" id="delete_item" ><i class="fa fa-lg fa-fw fa-trash"></i></button>
											</td>
										</tr>
										<?php 
											$c++;
...
<script type="text/javascript">
	var deleteItem=function(id){
		if (confirm('Are you sure want to delete the Item?')) {			
			...
			$.ajax({
				url : "<?php echo $this->config->item('base_url') ?>item/delete",
				type : "post",
				dataType : "json",
				data : 'id='+id,
